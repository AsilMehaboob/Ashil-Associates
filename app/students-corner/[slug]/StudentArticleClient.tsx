...
interface StudentArticleClientProps {
  post: StudentArticle;
  relatedPosts: StudentArticle[];
}

export default function StudentArticleClient({
  post,
  relatedPosts,
}: StudentArticleClientProps) {
  const fadeIn = {
        ...
        <article className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 font-sans text-sm">
              Contributing to educational content for aspiring Chartered Accountants
              at Ashil & Associates.
            </p>
          </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {relatedPosts.map((relatedPost) => (
                  <Link
                    ...
                    href={`/students-corner/${relatedPost.slug}`}
          ...
          >
            <h2 className="text-2xl md:text-3xl font-serif text-black mb-4">
              Interested in Articleship?
            </h2>
            <p className="text-gray-600 font-sans text-base leading-relaxed mb-8 max-w-xl mx-auto">
              Start your CA journey with practical experience at Ashil & Associates.
